...
void registerJuceCoreBindings ([[maybe_unused]] pybind11::module_& m)
{
   ...
   //.def_static ("charToString", &String::charToString)
    ...
    //.def ("end", &String::end)
        ...
        .def_static ("toHexString", &String::template toHexString<int8>)
        .def_static ("toHexString", &String::template toHexString<uint8>)
        .def_static ("toHexString", &String::template toHexString<short>)
        .def_static ("toHexString", &String::template toHexString<unsigned short>)
        .def_static ("toHexString", &String::template toHexString<int>)
        .def_static ("toHexString", &String::template toHexString<unsigned int>)
        .def_static ("toHexString", &String::template toHexString<long>)
        .def_static ("toHexString", &String::template toHexString<unsigned long>)
        .def_static ("toHexString", &String::template toHexString<int64>)
        .def_static ("toHexString", &String::template toHexString<uint64>)
    //.def_static ("toHexString", &String::toHexString)
