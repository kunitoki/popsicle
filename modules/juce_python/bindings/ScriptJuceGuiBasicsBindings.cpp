...
void registerJuceGuiBasicsBindings (py::module_& m)
{
    ...
    classHyperlinkButton
        ...
        .def ("setJustificationType", [](HyperlinkButton& self, int flags) { self.setJustificationType (static_cast<Justification::Flags> (flags)); })
    ...
    classLabel
        ...
        .def ("setJustificationType", [](Label& self, int flags) { self.setJustificationType (static_cast<Justification::Flags> (flags)); })
